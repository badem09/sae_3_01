    ...
    <body>
        ...
        <div class='container-module-parent'>
                        ...
                        <script>
                            function displayInfo(){
                                Swal.fire({
                                    ...
                                    text: "Ce module permet de crypter et décrypter un message à l'aide d'une clé personalisée, en utilisant le principe du cryptage RC4.",
            ...
            <div class="div-affi-histo-mod2">
                ...
                <a href="module2_1.php" aria-label="lien_page_module2_1"><input id="historique" name="historique" type="submit" value="Cacher votre historique"></input></a>
