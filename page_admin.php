            ...
            <div class="affichage">
                <?php
                    ...
                    elseif (isset($_POST["activitemodule"])) {
                        ...
                        $requete3 = mysqli_query($connexion, $requete1);
			$requete4 = mysqli_query($connexion, $requete2);
                        affichage_requete($table."_gen", $requete3);
			affichage_requete($table."_stat", $requete4);
                    }
...
<?php
	...
	echo "<table class='tab'>";
        ...
        if ($table == "activiteconnexion") {
            echo "<tr id='titre_tab1'><th>ID Connexion</th><th>MDP</th><th>Login tente</th><th>Horaire de la tentative</th><th>Adresse IP</th></tr>";
        }
